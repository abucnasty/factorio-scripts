...
export class CraftingSequenceFactory {

    public static createEmpty(): CraftingSequence {
        return {
            craft_events: [],
            snapshots_per_tick: [],
    ...
    public static createForMachine(machineState: Readonly<MachineState>): CraftingSequence {
