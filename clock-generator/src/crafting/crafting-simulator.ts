...
export class CraftingSimulator {
    ...
    public static simulateMachineCraftForTicks(
        ...
        if (!this.machineHasEnoughInputsForCraft(clonedState)) {
    ...
    public static machineHasEnoughInputsForCraft(machineState: MachineState): boolean {
    ...
    public static machineInputIsBlocked(machineState: MachineState, ingredientName: string): boolean {

        if (this.machineIsOutputBlocked(machineState)) {
            return true;
        }
    ...
    public static machineIsOutputBlocked(machineState: MachineState): boolean {
        const machine = machineState.machine;
